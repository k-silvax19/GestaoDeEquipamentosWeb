...
public class ChamadoController : Controller
{
    ...
    public ActionResult Cadastrar()
    {
        ...
        CadastrarChamadosViewModel cadastrarVm = new CadastrarChamadosViewModel(string.Empty, null, string.Empty);

        return View(cadastrarVm);
    }

    [HttpPost]
    public ActionResult Cadastrar(CadastrarChamadosViewModel cadastrarVm)
    {
    ...
    public ActionResult Editar(EditarChamadoViewModel editarVm)
    {
        ...
        repositorioChamado.Editar(editarVm.Id, chamadoEditado);
